...
class DataTransformation:
    ...
    def initiate_data_transformation(self):
        ...
        try:
            ...
            y = dataframe[TARGET_COLUMN]  # replacing the values of the target column

            # Ensure y has more than one class
            if len(y.unique()) < 2:
                raise ValueError("The target variable should have more than one class for sampling.") 
