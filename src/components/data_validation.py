...
class DataValidation:
    ...
    def validate_file_name(self,
        ...
        """
            ...
            On Failure  :   Write an exception log and then raise an exceptio
        ...
        try:
            ...
            #regex = "['cleanedthyroiddata']+['\'']+[\d]+[\d]+\.csv"
            regex = r'^cleaned_data\.csv$'
    ...
    def validate_raw_files(self) -> bool:
        ...
        try:
            ...
            column_names, no_of_column = self.valuesFromSchema()
